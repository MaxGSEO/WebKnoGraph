...
class GraphDataProcessor:
    ...
    def process(self, node_features_df: pd.DataFrame, edge_list_df: pd.DataFrame):
        ...
        if valid_features.empty:
            self.logger.warning("No nodes with non-null features found. Assuming feature dimension 384 for imputation.")
            feature_dim = 384 # Common for 'all-MiniLM-L6-v2', assuming this is consistent
        else:
