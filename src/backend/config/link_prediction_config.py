...
class LinkPredictionConfig:
    ...
    embeddings_dir_path: str = "/content/drive/My Drive/WebKnoGraph/data/url_embeddings/"
    ...
    node_mapping_path: str = os.path.join(output_dir, "model_metadata.json") # Was node_mapping_path previously
